...
def drawMondrian(width, height, colornums, step=10):
    '''drawMondrian draws a bunch of squares.
    Params:
...
if __name__ == '__main__':
    ...
    drawMondrian(500, 500, COLORNUMS)
